                ...
                {(formikProps) => (
                    <Form>
                        <div className="form-inline">
                            ...
                            <div className="form-group mx-sm-3 mb-2">
                                {/* da problemas el formik cuando se utiliza un checkbox */}
                            ...
                            <Button
                                ...
                                //esto de abajo es otra forma de hacer el submit del formulario. Podemos usar tambien un boton tipo submit si lo preferimos
