        ...
        <div style={{display: 'flex'}}>
            <div>
                ...
                {pelicula.generos?.map(genero => 
                    <Link key={genero.id} style={{marginRight: '5px'}} className='btn btn-primary btn-sm rounded-pill' to={`/peliculas/filtrar?generoId=${id}`}>
                        {genero.nombre}
                    </Link>
                    )
                }
                ...
                <div>
                    <h2>En emisión en los siguientes cines</h2>
